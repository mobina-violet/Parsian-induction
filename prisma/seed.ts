...
const products = [
  // ========== کوره‌ها ==========
  {
    ...
    description:
      "کوره‌های القایی ذوب پارسیان با طراحی اینورتر رزونانس موازی، ذوب تمیز و بدون آلودگی فلزات آهنی و غیرآهنی (فولاد، چدن، آلومینیوم و مس) رو با راندمان بالا و کنترل دقیق دما فراهم می‌کنند. این روش یکی از مفیدترین و تمیزترین روش‌های گرمایش بدون تماس مواد است و باعث ایجاد ناخالصی یا آلودگی در ذوب نمی‌شود. در طراحی سیستم اینورتر رزونانس موازی، انتخاب خازن مناسب بر اساس فرکانس رزونانس، توان خروجی، ضریب قدرت، کیفیت و کارایی کوره بسیار مهم است. این خط تولید از ظرفیت‌های کوچک کارگاهی تا واحدهای صنعتی بزرگ رو پوشش می دهد",
    capacityKg: null,
    powerKw: null,
    frequencyHz: null,
    variants: [
  ...
  },
  {
    ...
    description:
      "کوره‌های القایی پیش‌گرم و فورج پارسیان بر اساس سفارش مشتری، توان مورد نیاز و نوع کاربری طراحی و ساخته می‌شوند. این کوره‌ها با دانش روز و سال‌ها تجربه، قطعات فلزی رو تا دمای مشخص پیش‌گرم می‌کنند تا آماده عملیات فورج شنوند. مزایای اصلی: اپراتوری بسیار ساده، عدم ایجاد اکسید روی قطعه به دلیل زمان کوتاه حرارت‌دهی، شروع به کار سریع، راندمان بالا، کنترل دقیق دما، اشغال فضای کمتر و قابلیت اتوماسیون با خط تولید.",
    capacityKg: null,
    powerKw: null,
    frequencyHz: null,
    variants: [
  ...
  },
  {
    ...
    images: [
      ...
      "/images/products/hardening-furnace5.webp",
    ],
    featured: false,
    order: 3,
  },
  // ========== خدمات ==========
  {
    ...
    description:
      "پارسیان تمام قطعات مصرفی و یدکی کوره‌های القایی رو با کیفیت اصلی تأمین می‌کند. از تریستور و خازن‌های آب‌خنک گرفته تا بردهای الکترونیکی پارسیان، کویل مسی، یوک، شیلنگ‌های بدون کربن و مواد عایق‌کاری. همه قطعات با استانداردهای اصلی کوره سازگار هستند و باعث افزایش طول عمر و کاهش زمان توقف تولید می‌شنوند",
    capacityKg: null,
    powerKw: null,
    frequencyHz: null,
    variants: [],
  ...
  },
  {
    ...
    description:
      "تجهیزات جانبی کامل کوره‌های القایی پارسیان شامل کابل‌های آب‌خنک، یوک و دی‌سی چوک، بلوک‌های بالای کوره، کلید چنج‌اور، ترانس‌های جریان و کنترل، تجهیزات هیدرولیک و سایر اجزای مورد نیاز. همه این قطعات با طراحی استاندارد و کیفیت بالا تولید و تأمین می‌شوند تا عملکرد پایدار و ایمن کوره تضمین شود",
    capacityKg: null,
    powerKw: null,
    frequencyHz: null,
    variants: [],
